...
const Order = () => {
    ...
    const onSubmit = (data) => {
        ...
        data.Design = {title};
        fetch('https://fierce-beyond-80883.herokuapp.com/NewOrder', {
            method : 'POST',
            headers : {
            ...
            <div className="row">
                    ...
                    <div className="col-md-9">
                        <div className="orderSubmit">
                            ...
                            <input name="Design" value={title} style={{width:'570px', padding:'20px 10px'}} placeholder='Developer' className='form-control form_input' ref={register({ required: true })} disabled/> <br/>
